...
- Removed manual input text areas for documents (now auto-detected).
- Removed duplicate legacy code and cleaned up the UI structure.
...
- **Build**: Frontend build successful after removing duplicate code blocks.
